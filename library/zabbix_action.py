...
from ansible_collections.community.zabbix.plugins.module_utils.wrappers import (
    ZapiWrapper,
)
...
class Zapi(ZapiWrapper):
    ...
    def check_if_action_exists(self, name):
        ...
        try:
            ...
            if len(_action) > 0:
                _action[0]["recovery_operations"] = _action[0].pop(
                    "recoveryOperations", []
                )
                _action[0]["update_operations"] = _action[0].pop("updateOperations", [])
            return _action
        except Exception as e:
            self._module.fail_json(
                msg="Failed to check if action '%s' exists: %s" % (name, e)
            )
    ...
    def get_hostgroup_by_hostgroup_name(self, hostgroup_name):
        ...
        try:
            hostgroup_list = self._zapi.hostgroup.get(
                {"output": "extend", "filter": {"name": [hostgroup_name]}}
            )
            ...
            self._module.fail_json(
                msg="Failed to get host group '%s': %s" % (hostgroup_name, e)
            )
    ...
    def get_template_by_template_name(self, template_name):
        ...
        try:
            template_list = self._zapi.template.get(
                {"output": "extend", "filter": {"host": [template_name]}}
            )
            ...
            self._module.fail_json(
                msg="Failed to get template '%s': %s" % (template_name, e)
            )
    ...
    def get_trigger_by_trigger_name(self, trigger_name):
        ...
        try:
            trigger_list = self._zapi.trigger.get(
                {"output": "extend", "filter": {"description": [trigger_name]}}
            )
            ...
            self._module.fail_json(
                msg="Failed to get trigger '%s': %s" % (trigger_name, e)
            )
    ...
    def get_discovery_rule_by_discovery_rule_name(self, discovery_rule_name):
        ...
        try:
            discovery_rule_list = self._zapi.drule.get(
                {"output": "extend", "filter": {"name": [discovery_rule_name]}}
            )
            if len(discovery_rule_list) < 1:
                self._module.fail_json(
                    msg="Discovery rule not found: %s" % discovery_rule_name
                )
            else:
                return discovery_rule_list[0]
        except Exception as e:
            self._module.fail_json(
                msg="Failed to get discovery rule '%s': %s" % (discovery_rule_name, e)
            )
    ...
    def get_discovery_check_by_discovery_check_name(self, discovery_check_name):
        ...
        try:
            discovery_check_list = self._zapi.dcheck.get(
                {"output": "extend", "filter": {"key_": [discovery_check_name]}}
            )
            if len(discovery_check_list) < 1:
                self._module.fail_json(
                    msg="Discovery check not found: %s" % discovery_check_name
                )
            else:
                return discovery_check_list[0]
        except Exception as e:
            self._module.fail_json(
                msg="Failed to get discovery check '%s': %s" % (discovery_check_name, e)
            )
    ...
    def get_proxy_by_proxy_name(self, proxy_name):
        ...
        try:
            proxy_list = self._zapi.proxy.get(
                {"output": "extend", "filter": {"host": [proxy_name]}}
            )
            if len(proxy_list) < 1:
    ...
    def get_mediatype_by_mediatype_name(self, mediatype_name):
        ...
        try:
            ...
            self._module.fail_json(
                msg="Failed to get mediatype '%s': %s" % (mediatype_name, e)
            )
    ...
    def get_usergroup_by_usergroup_name(self, usergroup_name):
        ...
        try:
            usergroup_list = self._zapi.usergroup.get(
                {"output": "extend", "filter": {"name": [usergroup_name]}}
            )
            ...
            self._module.fail_json(
                msg="Failed to get user group '%s': %s" % (usergroup_name, e)
            )
    ...
    def get_script_by_script_name(self, script_name):
        ...
        try:
            ...
            script_list = self._zapi.script.get(
                {"output": "extend", "filter": {"name": [script_name]}}
            )
            ...
            self._module.fail_json(
                msg="Failed to get script '%s': %s" % (script_name, e)
            )
...
class Action(ZabbixBase):
    ...
    def _construct_parameters(self, **kwargs):
        ...
        _params = {
            ...
            "eventsource": to_numeric_value(
                ["trigger", "discovery", "auto_registration", "internal"],
                kwargs["event_source"],
            ),
        ...
        if kwargs["event_source"] == "trigger":
            if LooseVersion(self._zbx_api_version) >= LooseVersion("4.0"):
                _params["pause_suppressed"] = (
                    "1" if kwargs["pause_in_maintenance"] else "0"
                )
            else:
                _params["maintenance_mode"] = (
                    "1" if kwargs["pause_in_maintenance"] else "0"
                )
        ...
        if LooseVersion(self._zbx_api_version) < LooseVersion("3.4") or LooseVersion(
    ...
    def check_difference(self, **kwargs):
        ...
        """
        existing_action = convert_unicode_to_str(
            self._zapi_wrapper.check_if_action_exists(kwargs["name"])[0]
        )
        parameters = convert_unicode_to_str(self._construct_parameters(**kwargs))
        change_parameters = {}
        _diff = cleanup_data(
            compare_dictionaries(parameters, existing_action, change_parameters)
        )
        return _diff
        ...
        try:
            if self._module.check_mode:
                self._module.exit_json(
                    msg="Action would be updated if check mode was not specified: %s"
                    % kwargs,
                    changed=True,
                )
            ...
            self._module.fail_json(
                msg="Failed to update action '%s': %s" % (kwargs["actionid"], e)
            )
    ...
    def add_action(self, **kwargs):
        ...
        try:
            if self._module.check_mode:
                self._module.exit_json(
                    msg="Action would be added if check mode was not specified",
                    changed=True,
                )
            ...
            self._module.fail_json(
                msg="Failed to create action '%s': %s" % (kwargs["name"], e)
            )
    ...
    def delete_action(self, action_id):
        ...
        try:
            if self._module.check_mode:
                self._module.exit_json(
                    msg="Action would be deleted if check mode was not specified",
                    changed=True,
                )
            return self._zapi.action.delete([action_id])
        except Exception as e:
            self._module.fail_json(
                msg="Failed to delete action '%s': %s" % (action_id, e)
            )
...
class Operations(Zapi):
    def _construct_operationtype(self, operation):
        ...
        try:
            ...
            self._module.fail_json(
                msg="Unsupported value '%s' for operation type." % operation["type"]
            )
    ...
    def _construct_opmessage(self, operation):
        ...
        try:
            payload = {
                "default_msg": "0"
                if operation.get("message") is not None
                or operation.get("subject") is not None
                else "1",
                "message": operation.get("message"),
                "subject": operation.get("subject"),
            }
            if operation.get("media_type"):
                payload[
                    "mediatypeid"
                ] = self._zapi_wrapper.get_mediatype_by_mediatype_name(
                    operation.get("media_type")
                )
            return payload
        except Exception as e:
            self._module.fail_json(
                msg="Failed to construct operation message. The error was: %s" % e
            )
    ...
    def _construct_opmessage_grp(self, operation):
        ...
        return [
            {
                "usrgrpid": self._zapi_wrapper.get_usergroup_by_usergroup_name(_group)[
                    "usrgrpid"
                ]
            }
        ...
        try:
            return {
                "type": to_numeric_value(
                    ["custom_script", "ipmi", "ssh", "telnet", "global_script"],
                    operation.get("command_type", "custom_script"),
                ),
                "command": operation.get("command"),
                "execute_on": to_numeric_value(
                    ["agent", "server", "proxy"], operation.get("execute_on", "server")
                ),
                "scriptid": self._zapi_wrapper.get_script_by_script_name(
                    operation.get("script_name")
                ).get("scriptid"),
                "authtype": to_numeric_value(
                    ["password", "public_key"], operation.get("ssh_auth_type")
                ),
            ...
            self._module.fail_json(
                msg="Failed to construct operation command. The error was: %s" % e
            )
    ...
    def _construct_opcommand_hst(self, operation):
        ...
        return [
            ...
            for _host in operation.get("run_on_hosts")
        ]
    ...
    def _construct_opcommand_grp(self, operation):
        ...
        return [
            {
                "groupid": self._zapi_wrapper.get_hostgroup_by_hostgroup_name(_group)[
                    "hostid"
                ]
            }
    ...
    def _construct_optemplate(self, operation):
        ...
        return [
            {
                "templateid": self._zapi_wrapper.get_template_by_template_name(
                    _template
                )["templateid"]
            }
    ...
    def _construct_opinventory(self, operation):
        ...
        return {
            "inventory_mode": to_numeric_value(
                ["manual", "automatic"], operation.get("inventory")
            )
        }
    ...
    def construct_the_data(self, operations):
        ...
        for op in operations:
            ...
            if constructed_operation["operationtype"] == "0":
                ...
                constructed_operation["opmessage_usr"] = self._construct_opmessage_usr(
                    op
                )
                constructed_operation["opmessage_grp"] = self._construct_opmessage_grp(
                    op
                )
            ...
            if constructed_operation["operationtype"] == "1":
                ...
                constructed_operation["opcommand_hst"] = self._construct_opcommand_hst(
                    op
                )
                constructed_operation["opcommand_grp"] = self._construct_opcommand_grp(
                    op
                )
                constructed_operation["opconditions"] = self._construct_opconditions(op)
...
class RecoveryOperations(Operations):
    ...
    def _construct_operationtype(self, operation):
        ...
        try:
            ...
            self._module.fail_json(
                msg="Unsupported value '%s' for recovery operation type."
                % operation["type"]
            )
...
class UpdateOperations(Operations):
    ...
    def _construct_operationtype(self, operation):
        ...
        try:
            ...
            self._module.fail_json(
                msg="Unsupported value '%s' for update operation type."
                % operation["type"]
            )
...
class Filter(Zapi):
    def _construct_evaltype(self, _eval_type, _formula, _conditions):
        ...
        if _eval_type == "custom_expression":
            if _formula is not None:
                ...
                self._module.fail_json(
                    msg="'formula' is required when 'eval_type' is set to 'custom_expression'"
                )
        if _formula is not None:
            return {"evaltype": "3", "formula": _formula}
        return {"evaltype": "0", "formula": None}
    ...
    def _construct_conditiontype(self, _condition):
        ...
        try:
            ...
            self._module.fail_json(
                msg="Unsupported value '%s' for condition type." % _condition["type"]
            )
    ...
    def _construct_operator(self, _condition):
        ...
        try:
            ...
            self._module.fail_json(
                msg="Unsupported value '%s' for operator." % _condition["operator"]
            )
    ...
    def _construct_value(self, conditiontype, value):
        ...
        try:
            # Host group
            if conditiontype == "0":
                return self._zapi_wrapper.get_hostgroup_by_hostgroup_name(value)[
                    "groupid"
                ]
            # Host
            if conditiontype == "1":
            ...
            # Trigger
            if conditiontype == "2":
                return self._zapi_wrapper.get_trigger_by_trigger_name(value)[
                    "triggerid"
                ]
            ...
            # Trigger value
            if conditiontype == "5":
                return to_numeric_value(["ok", "problem"], value or "ok")
            ...
            # Discovery status
            if conditiontype == "10":
                return to_numeric_value(["up", "down", "discovered", "lost"], value)
            if conditiontype == "13":
                return self._zapi_wrapper.get_template_by_template_name(value)[
                    "templateid"
                ]
            if conditiontype == "18":
                return self._zapi_wrapper.get_discovery_rule_by_discovery_rule_name(
                    value
                )["druleid"]
            if conditiontype == "19":
                return self._zapi_wrapper.get_discovery_check_by_discovery_check_name(
                    value
                )["dcheckid"]
            if conditiontype == "20":
                return self._zapi_wrapper.get_proxy_by_proxy_name(value)["proxyid"]
            if conditiontype == "21":
                return to_numeric_value(["pchldrfor0", "host", "service"], value)
            if conditiontype == "23":
                return to_numeric_value(
                    [
    ...
    def construct_the_data(self, _eval_type, _formula, _conditions):
        ...
        _constructed_evaltype = self._construct_evaltype(
            _eval_type, _formula, constructed_data["conditions"]
        )
...
def main():
    ...
    argument_spec.update(
        dict(
            ...
            eval_type=dict(
                ...
                required=False,
                default=None,
                choices=["andor", "and", "or", "custom_expression"],
            ),
            operations=dict(
                type="list",
                required=False,
                ...
                options=dict(
                    ...
                    execute_on=dict(
                        type="str", required=False, choices=["agent", "server", "proxy"]
                    ),
                    ...
                    ssh_auth_type=dict(
                        type="str", required=False, choices=["password", "public_key"]
                    ),
                    ...
                    inventory=dict(
                        type="str", required=False, choices=["manual", "automatic"]
                    ),
                ...
                required_if=[
                    ...
                    [
                        "ssh_auth_type",
                        "public_key",
                        ["username", "ssh_privatekey_file", "ssh_publickey_file"],
                    ],
    ...
    module = AnsibleModule(
        ...
        required_if=[["state", "present", ["esc_period", "event_source"]]],
    ...
    if action_exists:
        ...
        if state == "absent":
            ...
            module.exit_json(
                changed=True, msg="Action Deleted: %s, ID: %s" % (name, result)
            )
        else:
            difference = action.check_difference(
                ...
                recovery_operations=recovery_ops.construct_the_data(
                    recovery_operations
                ),
                update_operations=update_ops.construct_the_data(update_operations),
            ...
            if difference == {}:
                ...
                module.exit_json(
                    changed=True, msg="Action Updated: %s, ID: %s" % (name, result)
                )
    else:
        if state == "absent":
            ...
            module.exit_json(
                changed=True, msg="Action created: %s, ID: %s" % (name, action_id)
            )
